...
class WebController extends Controller
{
    ...
    public function home()
    {
        ...
        return view('web-views.home', compact('diseases','featured_products', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories'));
    }
    ...
    public function product($slug)
    {
        ...
        if ($product != null) {
            ...
            $relatedProducts = Product::with(['reviews'])->active()->where('category_ids', $product->category_ids)->where('id', '!=', $product->id)->limit(6)->get();
