...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'disease', 'as' => 'disease.', 'middleware' => ['module:product_management']], function () {
            Route::get('view', 'DiseaseController@index')->name('view');
            Route::get('fetch', 'DiseaseController@fetch')->name('fetch');
            Route::post('store', 'DiseaseController@store')->name('store');
            Route::post('edit', 'DiseaseController@edit')->name('edit');
            Route::post('update', 'DiseaseController@update')->name('update');
            Route::post('delete', 'DiseaseController@delete')->name('delete');
        });
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('update_bn_ed/{batch_number}/{expiry_date}/{id}', 'OrderController@updateBnEd')->name('update.bn.ed');
            Route::get('check_bn_ed/{order_id}', 'OrderController@checkBnEd')->name('check.bn.ed');
            Route::post('store_package_detail/{order_id}', 'OrderController@storePackageDetail')->name('store.package.detail');
