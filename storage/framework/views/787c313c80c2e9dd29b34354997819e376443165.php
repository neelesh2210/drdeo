...
<?php $__env->startSection('content'); ?>
    <div class="container for-container rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
        <h2 class="text-center mt-3 headerTitle"><?php echo e(\App\CPU\translate('About Our Company')); ?></h2>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drdeo/web/drdeo.co.in/public_html/resources/views/web-views/about-us.blade.php ENDPATH**/ ?>