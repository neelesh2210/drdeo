...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="hs-unfold float-right col-6">
                                <div class="dropdown">
                                    <select name="order_status" onchange="order_status(this.value)"
                                            ...
                                            data-id="<?php echo e($order['id']); ?>" id="order_status">
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="batch_number" value="<?php echo e($detail->batch_number); ?>" id="batch_number_<?php echo e($detail->id); ?>" required>
                                            </div>
                                            <div class="col col-md-4">
                                                <label for="expiry_date">Expiry Date</label>
                                                <input class="form-control" type="date" name="expiry_date" value="<?php echo e($detail->expiry_date); ?>" id="expiry_date_<?php echo e($detail->id); ?>" required>
                                            </div>
                                            <div class="col col-md-3 ">
                                                <br>
                                                <button class="form-control" onclick="submit_form(<?php echo e($detail->id); ?>)">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- End Modal -->
    <!--Show Package Description Modal -->
    <div class="modal fade" id="packageDescriptionModel" tabindex="-1" role="dialog" aria-labelledby="packageDescriptionLable">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Enter Package Detail</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="pc_close"><span
                        aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 modal_body_map">
                            <span style="color:red;display:none" id="valid_form">*All Feilds are required</span>
                            <form class="form" id="package_detail_form" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-12 text-center">
                                    <br>
                                    <button class="btn btn-xs btn-secondary" type="button" onclick="package_detail_submit()">Submit</button>
                                </div>
                            </div>
                            </form>
                        </div>
    ...
    <!-- End Modal -->
    <button class="btn btn-xs btn-secondary" data-toggle="modal" data-target="#packageDescriptionModel" id="pc_div" style="display:none"><i class="tio-map"></i> dsfsdf</button>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        function order_status(status) {
            ...
            if(order_status == 'confirmed' || order_status == 'processing' || order_status == 'out_for_delivery' || order_status == 'delivered')
            {
                $.get("<?php echo e(route('admin.orders.check.bn.ed','')); ?>"+"/"+order_id, function(data) {
                    if(data != 0)
                    {
                        alert('You have to Fill Batch Number and Expiry Date First!');
                        return false;
                    }
                    else
                    {
                        ...
                        else
                        {
                            Swal.fire({
                            title: '<?php echo e(\App\CPU\translate('Are you sure Change this')); ?>?',
                            text: "<?php echo e(\App\CPU\translate('You will not be able to revert this1')); ?>!",
                            showCancelButton: true,
                            confirmButtonColor: '#377dff',
                            cancelButtonColor: 'secondary',
                            confirmButtonText: '<?php echo e(\App\CPU\translate('Yes, Change it')); ?>!'
        ...
        function package_detail_submit()
        {
            ...
            {
                var order_id='<?php echo e($order->id); ?>';
                $.post("<?php echo e(route('admin.orders.store.package.detail','')); ?>"+"/"+order_id, $("#package_detail_form").serialize(), function(data) {
                    $('#pc_close').click();
                    Swal.fire({
                            title: '<?php echo e(\App\CPU\translate('Are you sure Change this')); ?>?',
                            text: "<?php echo e(\App\CPU\translate('You will not be able to revert this1')); ?>!",
    ...
    <script>
        function submit_form(id)
        {
            ...
            {
                $.get("<?php echo e(route('admin.orders.update.bn.ed',['','',''])); ?>"+"/"+batch_number+"/"+expiry_date+"/"+id, function(data) {
                toastr.success('Batch Number Expiry Date Updated Successfully!')
            });
            }
        }
    </script>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\drdeo\resources\views/admin-views/order/order-details.blade.php ENDPATH**/ ?>