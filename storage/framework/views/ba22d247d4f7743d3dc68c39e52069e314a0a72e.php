                            ...
                            <?php else: ?>
                                <div class="row p-2">
                                    ...
                                    <div class="col-6" style="background-color: #FFFFFF; border-radius: 5px;">
                                        <img src="<?php echo e($custome_recaptcha->inline()); ?>" style="width: 100%; border-radius: 4px;"/>
                                    </div>
                                </div>
                            <?php endif; ?>
...
<?php /**PATH /home/drdeo/web/drdeo.co.in/public_html/resources/views/seller-views/auth/login.blade.php ENDPATH**/ ?>