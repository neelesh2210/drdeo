                                    ...
                                    <div class="card-body" style="height: 100px">
                                        <a class="btn btn-block click-if-alone" href="<?php echo e(route('paytm-payment')); ?>">
                                            <img style="max-width: 150px; margin-top: -10px"
                                                 src="<?php echo e(asset('public/assets/front-end/img/paytm.png')); ?>"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body" style="height: 100px">
                                        <a class="btn btn-block click-if-alone" href="<?php echo e(route('liqpay-payment')); ?>">
                                            <img style="max-width: 150px; margin-top: 0px"
                                                 src="<?php echo e(asset('public/assets/front-end/img/liqpay4.png')); ?>"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function click_if_alone() {
            ...
            if (Number.parseInt(total) < 2) {
                ...
                $('.checkout_details').html('<h1><?php echo e(\App\CPU\translate('Redirecting_to_the_payment_page')); ?>......</h1>');
            }
        }
        click_if_alone();
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drdeo/web/drdeo.co.in/public_html/resources/views/web-views/checkout-payment.blade.php ENDPATH**/ ?>