    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><?php echo e(\App\CPU\translate('Doctor Category')); ?></li>
            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="row">
            <div class="col-md-12" id="banner-btn">
                <button id="main-banner-add" class="btn btn-primary"><i
                        class="tio-add-circle"></i> <?php echo e(\App\CPU\translate('add_categories')); ?></button>
            </div>
        </div>
        <!-- Content Row -->
        <div class="row pt-4" id="main-banner"
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.doctor-settings.store.categories')); ?>" method="post" enctype="multipart/form-data"
                              class="banner_form">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img width="80"
                                                 ...
                                                 src="<?php echo e(asset('public/doctor_categories/')); ?>/<?php echo e($data['image']); ?>">
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" style="cursor: pointer;" href="<?php echo e(route('admin.doctor-settings.delete.category',$data['id'])); ?>"
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\drdeo\resources\views/admin-views/doctors/category.blade.php ENDPATH**/ ?>