                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="batch" class="form-control" id="batch"  value="<?php echo e($product->batch); ?>" placeholder="Batch No." >
                                    </div>
    
                                    <div class="col-md-6">
                                        <label for="name">Expire Date</label>
                                        <input type="date" name="exp" class="form-control" id="exp"  value="<?php echo e($product->exp); ?>" placeholder="Expire Date" >
                                    </div>
                                </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="disease" class="form-control" id="disease"  value="<?php echo e($product->disease); ?>" placeholder="Disease(comma seperated)" required>
                                        </div>
                                    </div>
                                    </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <option value="5" <?php echo e($product->tax== 5 ? 'selected':''); ?>>5%</option>
                                    <option value="12" <?php echo e($product->tax== 12 ? 'selected':''); ?>>12%</option>
                                    <option value="18" <?php echo e($product->tax== 18 ? 'selected':''); ?>>18%</option>
                                    <option value="22" <?php echo e($product->tax== 22 ? 'selected':''); ?>>22%</option>
                                        </select>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drdeo/web/drdeo.co.in/public_html/resources/views/admin-views/product/edit.blade.php ENDPATH**/ ?>