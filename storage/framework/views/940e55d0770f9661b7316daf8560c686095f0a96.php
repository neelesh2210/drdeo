                                ...
                                <div class="<?php echo e($lang != $default_lang ? 'd-none' : ''); ?> lang_form"
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="<?php echo e($lang); ?>_name"><?php echo e(\App\CPU\translate('name')); ?>
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea name="description[]" class="editor textarea" cols="30" rows="10" required><?php echo e(old('details')); ?></textarea>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-basic-multiple form-control" name="category_id"
                                            ...
                                            required>
                                            <option value="<?php echo e(old('category_id')); ?>" selected disabled>---Select---
                                            </option>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            ...
                                            <option value="<?php echo e(null); ?>" selected disabled>
                                                ---<?php echo e(\App\CPU\translate('Select')); ?>---</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="hsn" class="form-control" id="hsn"
                                            value="<?php echo e(old('hsn')); ?>" placeholder="HSN No." required>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="weight" class="form-control" id="weight"
                                            value="<?php echo e(old('weight')); ?>" placeholder="Weight" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="length">Length</label>
                                        <input type="number" name="length" class="form-control" id="length"
                                            value="<?php echo e(old('length')); ?>" placeholder="Length" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="width">Width</label>
                                        <input type="number" name="width" class="form-control" id="width"
                                            value="<?php echo e(old('width')); ?>" placeholder="Width" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="height">Height</label>
                                        <input type="number" name="height" class="form-control" id="height"
                                            value="<?php echo e(old('height')); ?>" placeholder="Height" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="buy_one_get_one">Buy One Get One</label>
                                        <select name="buy_one_get_one"
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            id="buy_one_get_one" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input type="number" min="0" value="<?php echo e(old('discount',0)); ?>"
                                            step="0.01" placeholder="<?php echo e(\App\CPU\translate('Discount')); ?>"
                                    ...
                                    <div class="col-md-6" id="quantity">
                                        <label class="control-label"><?php echo e(\App\CPU\translate('total')); ?>

                                            <?php echo e(\App\CPU\translate('Quantity')); ?></label>
                                        <input type="number" min="0" value="0" step="1"
                                            placeholder="<?php echo e(\App\CPU\translate('Quantity')); ?>" name="current_stock"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <small class="badge badge-soft-danger"> (
                                        <?php echo e(\App\CPU\translate('optional, please provide embed link not direct link')); ?>.
                                        )</small>
                                    <input type="text" name="video_link"
                                        placeholder="<?php echo e(\App\CPU\translate('EX')); ?> : https://www.link.com/embed/5R06LRdUCSE"
                                        class="form-control" required>
                                </div>
        ...
        $(function() {
            $("#coba").spartanMultiImagePicker({
                ...
                onExtensionErr: function(index, file) {
                    toastr.error(
                    '<?php echo e(\App\CPU\translate('Please only input png or jpg type file')); ?>', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                },
    ...
    <script>
        ...
        function add_more_customer_choice_option(i, name) {
            ...
            $('#customer_choice_options').append(
                ...
                '" placeholder="<?php echo e(trans('Choice Title')); ?>" readonly></div><div class="col-lg-9"><input type="text" class="form-control" name="choice_options_' +
                i +
                '[]" placeholder="<?php echo e(trans('Enter choice values')); ?>" data-role="tagsinput" onchange="update_sku()"></div></div>'
                );
