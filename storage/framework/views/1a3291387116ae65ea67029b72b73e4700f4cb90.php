            ...
            <div class="col-lg-12">
                <form action="<?php echo e(route('admin.report.set-date')); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <input type="date" name="from" value="<?php echo e(date('Y-m-d',strtotime($from))); ?>" id="from_date"
                                       class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                <input type="date" value="<?php echo e(date('Y-m-d',strtotime($to))); ?>" name="to" id="to_date"
                                       class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="js-circle"
                                     data-hs-circles-options='{
                                       "value": <?php echo e($total_earning==0?0:round((($total_earning)/$total)*100)); ?>,
                                       "maxValue": 100,
                                       "duration": 2000,
                                       "isViewportInit": true,
                                       "colors": ["#e7eaf3", "green"],
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="js-circle"
                                     data-hs-circles-options='{
                           "value": <?php echo e($total_tax==0?0:round(((abs($total_tax))/$total)*100)); ?>,
                           "maxValue": 100,
                           "duration": 2000,
                           "isViewportInit": true,
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="js-circle"
                                     data-hs-circles-options='{
                           "value": <?php echo e($total_commission==0?0:round(((abs($total_commission))/$total)*100)); ?>,
                           "maxValue": 100,
                           "duration": 2000,
                           "isViewportInit": true,
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drdeo/web/drdeo.co.in/public_html/resources/views/admin-views/report/earning-index.blade.php ENDPATH**/ ?>