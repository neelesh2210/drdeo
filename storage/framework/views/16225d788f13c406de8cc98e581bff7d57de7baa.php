...
<div class="steps steps-light pt-2 pb-2">
    ...
    <a class="step-item <?php echo e($step>=2?'active':''); ?> <?php echo e($step==2?'current':''); ?>" href="<?php echo e(route('checkout-details')); ?>">
        ...
        <div class="step-label">
            <?php echo e(\App\CPU\translate('Shipping_and_billing')); ?>
...
<?php /**PATH /home/drdeo/web/drdeo.co.in/public_html/resources/views/web-views/partials/_checkout-steps.blade.php ENDPATH**/ ?>