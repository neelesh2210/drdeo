...
@section('content')
    ...
    <section class="container mt-4 cat-mt1">
        <div class="hm-container card">
         <div class="hm-section hm-topCategoriesMobile">
            ...
            <div class="categoryItem" data-href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">
    ...
    <!-- ======= SHOP BY HEALTH CONCERN END ========-->
     ...
     <section class="container special-card">
        ...
        @foreach($secon_banner as $key=>$banner)
        ...
        <div class="hm-container card">
         <div class="hm-section hm-topCategoriesMobile">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6  hm-sectionTitle"><h2>Brands</h2></div>
                ...
                <div class="owl-carousel owl-theme " id="category-slider">
            @foreach($brands as $brand)
            <div class="categoryItem" data-href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}">
               <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}">
                  <span class="categoryIcon">
                     <img src="{{asset("storage/app/public/brand/$brand->image")}}">
                  </span>
                  <span class="categoryTitle">{{$brand->name}}</span>
               </a>
            </div>
            @endforeach
          </div>
