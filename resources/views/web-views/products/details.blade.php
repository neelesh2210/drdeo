...
@section('content')
    ...
    <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="row" style="direction: ltr">
            ...
            <!-- Product details-->
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                <div class="details">
    ...
    <div class="container  mb-3 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="flex-between">
            <div class="feature_header">
                <span style="background-color:white!important;">{{ \App\CPU\translate('similar_products')}}</span>
            </div>
