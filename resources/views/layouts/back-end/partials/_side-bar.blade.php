                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--order management ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/disease*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.disease.view')}}"
                                   title="Pages">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/doctor-settings/sliders')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.doctor-settings.sliders')}}">
                                <i class="tio-incognito nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('doctor_sliders')}}</span>
                            </a>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/doctor-settings/categories')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.doctor-settings.categories')}}">
                                <i class="tio-incognito nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('doctor_categories')}}</span>
                            </a>
                        </li>
