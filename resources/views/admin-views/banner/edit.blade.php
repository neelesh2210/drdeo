                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%"
                                                ...
                                                <option value="Secondary Banner" {{$banner['banner_type']=='Secondary Banner'?'selected':''}}>Secondary Banner</option>
                                                <option value="Side Banner" {{$banner['banner_type']=='Side Banner'?'selected':''}}>Side Banner</option>
                                                <option value="Product Banner" {{$banner['banner_type']=='Product Banner'?'selected':''}}>Product Banner</option>
                                            </select>
                                        </div>
