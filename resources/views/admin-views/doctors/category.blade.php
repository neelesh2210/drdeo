    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('Doctor Category')}}</li>
            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="row">
            <div class="col-md-12" id="banner-btn">
                <button id="main-banner-add" class="btn btn-primary"><i
                        class="tio-add-circle"></i> {{ \App\CPU\translate('add_categories')}}</button>
            </div>
        </div>
        <!-- Content Row -->
        <div class="row pt-4" id="main-banner"
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.doctor-settings.store.categories')}}" method="post" enctype="multipart/form-data"
                              class="banner_form">
                            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img width="80"
                                                 ...
                                                 src="{{asset('public/doctor_categories/')}}/{{$data['image']}}">
                                        </td>
                                        <td>{{$data->name}}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" style="cursor: pointer;" href="{{route('admin.doctor-settings.delete.category',$data['id'])}}"
