                            ...
                            <div class="form-group">
                                {{-- <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="batch" class="form-control" id="batch"  value="{{$product->batch}}" placeholder="Batch No." >
                                    </div>

                                    <div class="col-md-6">
                                        <label for="name">Expire Date</label>
                                        <input type="date" name="exp" class="form-control" id="exp"  value="{{$product->exp}}" placeholder="Expire Date" >
                                    </div>
                                </div> --}}
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="hsn" class="form-control" id="hsn"  value="{{$product->hsn}}" placeholder="HSN No." required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="name">SKU</label>
                                            <input type="text" name="sku" class="form-control" id="sku" value="{{$product->sku}}" placeholder="SKU" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="name">Disease</label>
                                            {{-- <input type="text" name="disease" class="form-control" id="disease"  value="{{$product->disease}}" placeholder="Disease(comma seperated)" required> --}}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="weight" class="form-control" id="weight" value="{{$product->weight}}" placeholder="Weight" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="length">Length</label>
                                            <input type="number" name="length" class="form-control" id="length" value="{{$product->length}}" placeholder="Length" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="width">Width</label>
                                            <input type="number" name="width" class="form-control" id="width" value="{{$product->width}}" placeholder="Width" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="height">Height</label>
                                            <input type="number" name="height" class="form-control" id="height" value="{{$product->height}}" placeholder="Height" required>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select name="buy_one_get_one" class="js-example-basic-multiple js-states js-example-responsive form-control" id="buy_one_get_one" required>
                                                ...
                                                @foreach (App\Model\Product::where('status',1)->get() as $product_buy)
                                                    <option value="{{$product_buy->id}}" @if($product->buy_one_get_one == $product_buy->id) selected @endif>{{$product_buy->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <option value="22" {{$product->tax== 22 ? 'selected':''}}>22%</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" value="{{$product['video_url']}}" name="video_link"
                                           placeholder="{{\App\CPU\translate('EX')}} : https://www.link.com/embed/5R06LRdUCSE"
                                           class="form-control" required>
                                </div>
